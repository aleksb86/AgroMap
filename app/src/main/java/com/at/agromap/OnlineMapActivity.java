...
public class OnlineMapActivity extends AppCompatActivity {
...
//    private static CharSequence msgSyncResultText = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent callTiledMapIntent = new Intent(OnlineMapActivity.this, TailedMapActivity.class);
...
//                }
        ...
        buttonSwitchToTiled.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                OnlineMapActivity.this.startActivity(callTiledMapIntent);
            }
        });

        if (isSDPresent) {
//            pathView.setText("SD card available");
//            pathView.setText("SD path: " + getApplicationContext().getExternalFilesDir(null).toString());
            pathView.setText("SD path: " + Environment.getExternalStorageDirectory().toString());
        } else {
