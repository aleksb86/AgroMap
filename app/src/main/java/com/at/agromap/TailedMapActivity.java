...
public class TailedMapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: настроить хранение на внешней карте SD -
        // есть соответствующая переменная в strings.xml
...
//                + DEFAULT_BASEMAP_PATH;
        ...
        // Вариант для хранения во встроенной памяти
        defaultPath = getApplicationContext().getFilesDir().toString();

        requestWindowFeature(Window.FEATURE_INDETERMINATE_PROGRESS);
        setContentView(R.layout.activity_tailed_map);
        mMapView = (MapView) findViewById(R.id.offline_map);

        // Add Tile layer to the MapView
        tileURL = getResources().getString(R.string.basemap_service_url);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.offline_map_menu, menu);
        // menu items
    ...
    private void createTileCache(ExportTileCacheParameters params,
        ...
        CallbackListener<ExportTileCacheStatus> statusListener =
